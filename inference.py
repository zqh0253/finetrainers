...
transformer = CogVideoXTransformer3DModel.from_pretrained(
    "debug_ckpt_separate/checkpoint-14000/transformer", torch_dtype=torch.bfloat16
    # "debug_ckpt_rgbrgb/checkpoint-37200/transformer", torch_dtype=torch.bfloat16
)
...
video = pipe(prompt, num_frames=9, height=256, width=256, num_inference_steps=50, separate_latents=True).frames[0]
