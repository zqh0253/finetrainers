...
transformer = CogVideoXTransformer3DModel.from_pretrained(
    "debug_ckpt_rgbrgb/checkpoint-500/transformer", torch_dtype=torch.bfloat16
)
...
video = pipe(prompt, num_frames=9, height=256, width=256, num_inference_steps=250).frames[0]
